...
mat_long <- pivot_longer(data = mat, cols = `HI.3202.006.Index_13.BM_shift90-NAB2-PrA-CSL4pH-URA-37C-m1+1`:`HI.3758.004.Index_19.BM-MO_mR-srm1-37C-90-8-2+140`, 
...
mat_long$strain <- ifelse(grepl(pattern = "Ctrl", mat_long$sample), "wt", mat_long$strain)
